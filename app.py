...
st.set_page_config(page_title="Portafolio Analysis by Leonardo Da Niel", layout="wide")
st.sidebar.title("App de Análisis de Carteras de Inversión by Leonardo Da Niel")
